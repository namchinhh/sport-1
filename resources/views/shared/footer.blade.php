<footer class="footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 marg-sm-50 col-xs-12 ">
                    <div class="footer-top_address float-lg-right float-md-right">
                        ...
                        <div><i class="fa fa-envelope-o"></i> {{ __('E-mail:') }} <span><a href="mailto:support@email.com">{{ __('E-mail:') }}support@email.com</a></span></div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="footer-bottom_copy">{{ __('Copyright © 2016 DeluxHotel. Design by ') }}<a href="https://themeforest.net/user/DankovThemes" target="_blank">{{ __('DankovThemes') }}</a></div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
