...
@section('content')
    <div class="container body">
        <div class="main_container">
            <div class="right_col" role="main" style="min-height: 3850px">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#editor-one">
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-info" data-edit="bold" title="Bold (Ctrl/Cmd+B)"><i
                                                class="fa fa-bold"></i></a>
                                    <a class="btn btn-info" data-edit="italic" title="Italic (Ctrl/Cmd+I)"><i
                                                class="fa fa-italic"></i></a>
                                    <a class="btn btn-info" data-edit="strikethrough" title="Strikethrough"><i
